...
def inference():
    ...
    # ))
    # model.load_state_dict(torch.load('/user/DETR/outputs/model'+str(NUM_EPOCHS)+'.pth', map_location=device))
    # model.load_state_dict(torch.load('/user/DETR/outputs/model_best_loss_finetuned.pth', map_location=device))
    model.load_state_dict(torch.load('/user/DETR/outputs/model_best_loss_rcnn_res.pth', map_location=device))
    model.eval()
    model.to(device)
    ...
    DIR_TEST = '/user/DETR/val'
    OUT_DIR = '/user/DETR/validation_results'
    ...
    validation_results.to_csv('/user/DETR/validation_results/validation_results.csv')
