...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for member in root.findall('object'):
            ...
            # convert to center_x, center_y, width, height format for the bounding boxes

            # center_x = (xmin_final + xmax_final) / 2
            # center_y = (ymin_final + yamx_final) / 2
            # width = xmax_final - xmin_final
            # height = yamx_final - ymin_final
