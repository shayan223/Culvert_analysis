...
if __name__ == '__main__':
    ...
    pretrained_weights=torch.load('/home/udaykanth/Assignments/DETR/Culvert_analysis/checkpoint0029_4scale_swin.pth', map_location=torch.device('cuda'))
    ...
    model=model.to(DEVICE)
    # model.load_state_dict(torch.load('/mnt/sdb1/udaykanth/DETR/outputs/model_best_loss_finetuned.pth', map_location=torch.device('cuda')))
