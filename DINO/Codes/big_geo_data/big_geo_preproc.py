...
def big_geo_preproc():
    # out_dir = './annotations'
    out_dir='/mnt/sdb1/udaykanth/DETR/annotations'
    ...
    df.apply(lambda x: generate_xml('/mnt/sdb1/udaykanth/DETR/Sample800_norm/'+"{}.tif".format(x['Sample Name']),x['Sample Name'],x['Culvert Local X'],x['Culvert Local Y'],BOUND_SIZE),axis=1)
