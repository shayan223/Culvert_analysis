...
def seperate_files():
    ...
    IMAGE_DIR = '/mnt/sdb1/udaykanth/DETR/Sample800_norm'
    ...
    def seperate_images(file_path,source,destination,validation=False):
        ...
        for filename in os.listdir(source):
            ...
            if current_file in file_list:
                ...
                annotation_file = os.path.join('/mnt/sdb1/udaykanth/DETR/annotations', current_file + '.xml')
    ...
    seperate_images("/mnt/sdb1/udaykanth/DETR/ImageSets/train.txt",IMAGE_DIR,'/mnt/sdb1/udaykanth/DETR/train')
    seperate_images("/mnt/sdb1/udaykanth/DETR/ImageSets/test.txt",IMAGE_DIR,'/mnt/sdb1/udaykanth/DETR/test')
    seperate_images("/mnt/sdb1/udaykanth/DETR/ImageSets/trainval.txt",IMAGE_DIR,'/mnt/sdb1/udaykanth/DETR/trainval')
    seperate_images("/mnt/sdb1/udaykanth/DETR/ImageSets/val.txt",IMAGE_DIR,'/mnt/sdb1/udaykanth/DETR/val',validation=True)
