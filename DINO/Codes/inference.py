...
def inference():
    ...
    # ))
    # model.load_state_dict(torch.load('/mnt/sdb1/udaykanth/DETR/outputs/model'+str(NUM_EPOCHS)+'.pth', map_location=device))
    # model.load_state_dict(torch.load('/mnt/sdb1/udaykanth/DETR/outputs/model_best_loss_finetuned.pth', map_location=device))
    model.load_state_dict(torch.load('/mnt/sdb1/udaykanth/DETR/outputs/model_best_loss_rcnn_res.pth', map_location=device))
    model.eval()
    model.to(device)
    ...
    DIR_TEST = '/mnt/sdb1/udaykanth/DETR/val'
    OUT_DIR = '/mnt/sdb1/udaykanth/DETR/validation_results'
    ...
    validation_results.to_csv('/mnt/sdb1/udaykanth/DETR/validation_results/validation_results.csv')
