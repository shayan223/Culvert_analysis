...
def analyse_val():
    ...
    val_res = pd.read_csv('/user/DETR/validation_results/validation_results.csv',index_col=False)
    labels = pd.read_csv('/user/DETR/validation_results/val_labels.csv')
    ...
    plt.savefig('/user/DETR/validation_results/confusion_matrix_rcnn_res.png')
    plt.clf()
